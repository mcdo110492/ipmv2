(function () {
	'use strict';
		angular
			...
			.controller('LicenseImageDialogController',LicenseImageDialogController);

			/** @ngInject */
			function LicenseImageDialogController(ModalConfig,data,toaster,api,FileUploader,$timeout)
			{
				var vm = this;
					...
					var uploader = vm.uploader = new FileUploader({
			            url: api.baseUrl+'employeeDetails/employeeLicenseUpload',
			            alias:'userfile1',
			            queueLimit: 1,
			            headers:{
