(function ()
{
    ...
    /** @ngInject */
    function EmploymentStatusDialogController(api,ModalConfig,toaster)
    {
        var vm          =   this;
            vm.loader   =   false;
            vm.urlPath  =   api.baseUrl+'employmentStatus/check';
            vm.save     = save;
            ...
            {
                vm.loader   =   true;
                api.employmentStatus.employmentStatus.save(data,success);
                function success(r)
                {
                    if(r.status == 200)
                    {
